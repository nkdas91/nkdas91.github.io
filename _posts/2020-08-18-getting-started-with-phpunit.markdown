...
<div class="p-3 my-3 author-note theme-text-color-primary">
Before we begin,<br>  
...
<div class="p-3 my-3 author-note theme-text-color-primary">Also check tests/UserTest.php for another example.</div>
